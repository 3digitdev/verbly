...
{
	if (region.U.C === region.aa.C)
	{
		return 'on line ' + region.U.C;
	}
	return 'on lines ' + region.U.C + ' through ' + region.aa.C;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aV, request.bh, true);
		} catch (e) {
...
var $author$project$Translate$initModel = {B: $author$project$Translate$Empty, n: '', r: ''};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{aG: false, aI: r.aI, aN: r.aN, ag: r.ag, aV: r.aV, bd: r.bd, aC: r.aC, bh: r.bh}));
};
...
var $author$project$Api$get = F3(
	function (endpoint, decoder, cmd) {
		return $elm$http$Http$get(
			{
				aN: A2($elm$http$Http$expectJson, cmd, decoder),
				bh: $author$project$Api$urlBuilder(endpoint)
			});
	});
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 1:
				return _Utils_Tuple2(
					model,
					$author$project$Translate$getConjugation(model.r));
			case 0:
				var result = msg.a;
				if (result.$ === 1) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								B: $author$project$Translate$Empty,
								n: A2($author$project$Api$errorToString, httpError, model.r)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var conj = result.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								B: $author$project$Translate$Resp(conj),
								n: ''
							}),
						$elm$core$Platform$Cmd$none);
				}
			default:
				return _Utils_Tuple2(
					model,
					$author$project$Translate$getVerbFromConjugation(model.r));
		}
	});
var $author$project$Translate$init = function (_v0) {
...
var $author$project$Translate$subscriptions = function (_v0) {
...
var $author$project$Translate$renderErrors = function (model) {
	return (model.n === '') ? $elm$html$Html$text(model.n) : A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Translate$renderVerb = function (_v0) {
	var verb = _v0.a;
	var conjList = _v0.b;
	return A2(
		$elm$html$Html$table,
...
var $author$project$Translate$main = $elm$browser$Browser$element(
	{aT: $author$project$Translate$init, bc: $author$project$Translate$subscriptions, bg: $author$project$Translate$update, bj: $author$project$Translate$view});
