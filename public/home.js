...
{
	if (region.S.z === region._.z)
	{
		return 'on line ' + region.S.z;
	}
	return 'on lines ' + region.S.z + ' through ' + region._.z;
}
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Welcome To Verbly!')
									])),
								A2(
								$elm$html$Html$h2,
								_List_fromArray(
...
var $author$project$Home$main = $elm$browser$Browser$element(
	{aQ: $author$project$Home$init, a5: $author$project$Home$subscriptions, a9: $author$project$Home$update, ba: $author$project$Home$view});
